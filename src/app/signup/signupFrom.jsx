...
const signupFrom = () => {
  ...
  return (
    <div className="w-full max-w-md container mx-auto my-40 p-8 space-y-3 rounded-xl bg-gray-900 text-gray-100">
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        <div className="space-y-1 text-sm">
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-md border-gray-700 bg-gray-900 dark:text-gray-100 focus:border-violet-400"
          />
        </div>
        <div className="space-y-1 text-sm">
          <label for="password" className="block text-gray-400">
