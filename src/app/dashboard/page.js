        ...
        >
          <div class="space-y-6 md:space-y-10 mt-10">
            <h1 class="font-bold text-4xl text-center md:hidden">
              MHM<span class="text-teal-600">.</span>
            </h1>
            <h1 class="hidden md:block font-bold text-sm md:text-xl text-center">
              Stay With Moon<span class="text-teal-600">.</span>
            </h1>
            <div id="profile" class="space-y-3">
              <img
                src="https://i.ibb.co/ZxRmCW2/20230526-214320.jpg"
                alt="Avatar user"
                class="w-30 md:w-30 h-20 object-cover rounded-full mx-auto"
              />
              <div>
            ...
            <div id="menu" class="flex flex-col space-y-2">
              ...
              >
                ...
                <span class="">Add Photography</span>
              </a>
            </div>
          </div>
        </div>
