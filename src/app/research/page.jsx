...
const page = () => {
  const researchData = [
    {
      title: "Ankor Research 1",
      description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit.",
    },
    {
      title: "Ankor Research 2",
      description:
  ...
  return (
    <ul className="p-4 mx-auto container lg:p-8 bg-gray-200 text-black-100">
      <li>
        <article>
          <a
            rel="noopener noreferrer"
            href="#"
            className="grid p-4 overflow-hidden md:grid-cols-5 rounded-xl lg:p-6 xl:grid-cols-12 hover:bg-gray-400"
          >
